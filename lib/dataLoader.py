...
def read_accounts(spark, env, enable_hive, hive_db):
    runtime_filter = confLoader.get_data_filter(env, "account.filter")
...
def read_parties(spark, env, enable_hive, hive_db):
    runtime_filter = confLoader.get_data_filter(env, "party.filter")
...
def read_address(spark, env, enable_hive, hive_db):
    runtime_filter = confLoader.get_data_filter(env, "address.filter")
